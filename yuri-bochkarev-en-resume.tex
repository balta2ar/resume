        ...
        {December 2024 -- present}
        {
            \begin{itemize}
                \item{Developed a service to parse uploaded PDFs and extract
                    page metadata and structure information (Golang, gRPC, pdfcpu)}
                \item{Developed a prototype of a next-generation
                    synchronization protocol and service (Golang, HTTP,
                    WebSockets, PostgreSQL, Spanner)}
                \item{Ensured service quality by implementing end-to-end tests}
                \item{Keywords: Golang, GCP/Google Cloud, Grafana, Spanner, Firebase, Cloud Run, Terraform}
            \end{itemize}
        }
    }
